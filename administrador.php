        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item flex-fill"><a href="historico.php" class="btn btn-dark btn-primario">Ver Histórico</a></li>
                    <li class="list-group-item flex-fill"><a href="monitoreo.php" class="btn btn-dark btn-primario">Monitoreo en Tiempo Real</a></li>
                    <li class="list-group-item flex-fill"><a href="cuentas.php" class="btn btn-dark btn-primario">Administrar Cuentas</a></li>
